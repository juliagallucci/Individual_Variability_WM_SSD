...
#SBATCH --output=/projects/jgallucci/PALM/PALM_conmat_T_group_diff_Ctrl_Scz_%j.txt
#SBATCH --array=1-3
...
truncname="$(echo $(basename `echo "$filename"`) | sed 's/file_ls/PALM_group_diff_Ctrl_Scz_con00/;s/.txt//')"
outdir="${DIR}/Results/$truncname"
desmat="${DIR}/con_design_matrix/groupdiff_Ctrl_Scz_design.csv"
conmat="${DIR}/con_design_matrix/contrast_matrix.csv"
